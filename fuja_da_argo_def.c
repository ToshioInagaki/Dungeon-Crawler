	...
	*/
	...
	void gameover(){
		...
		printf("\t\t\t\t\t                                                                                                          \n");
		printf("\t\t\t\t\t                                                                                                          \n");
	  	printf(" \n\n\n\n\t\t\t\t  Parece que os monstros estao se divertindo a sua custa. Sera que voce e realmente tao ruim em fugir? Talvez seja hora de aceitar o seu destino...\n\n\n\n\n\n\n\n\t\t\t\t\t\t\t\t\t           --PRESSIONE QUALQUER TECLA PARA VOLTAR AO MENU--\n");
	  	getch();
		w = 0;
		life = 3;
		contfase = 0;
	...
	void ending(){
		system("cls");
		printf("\nApos escapar da Argo, Serruya comemora sua liberdade com bebidas e fortune dragon, pois o tigrinho nao esta pagando. No entanto, a medida que a luz do dia comeca a raiar,");
		printf(" Serruya tem um momento de lucidez e se   lembra que faltam poucas horas para a aula da Alessandra, sua professora mais temida. Serruya ");
		printf("passa mal so de imaginar o olhar desapontado da professora ao descobrir sua ausencia.\n");
		getch();
		system("cls");
		printf("\nEnquanto a festanca acontecia ao seu redor, Serruya percebe que, apesar de ter conseguido sobreviver, ainda existiam responsabilidades que o aguardavam. ");
		printf("Ele respira fundo e vai para a faculdade, com ressaca e   triste por ter perdido todo o seu dinheiro apostando.\n");
		getch();
		system("cls");
		printf("\nDurante a aula da Alessandra, Serruya tentou acompanhar a explicacao sobre numeros binarios, porem, sucumbiu ao cansaco novamente...\n");
		getch();
		system("cls");
		printf("\nO resto e historia.\n");
	    getch();
	...
	void morreu(){
		...
		if(zoacaomorte == 2){
			printf(" \n\n\n\n\t\t\t\t\t\t\t\t\t\t\t          Tranca o curso, irmao.\n\n\n\n\n\n\n\n\t\t\t\t\t\t\t\t\t           -- APERTE QUALQUER BOTAO PARA TENTAR DE NOVO --\n");
	    	
		}
		
		if(zoacaomorte == 3){
			printf(" \n\n\n\n\t\t\t\t\t\t\t\t\t\t\t       Alguem assobiou demais...\n\n\n\n\n\n\n\n\t\t\t\t\t\t\t\t\t           -- APERTE QUALQUER BOTAO PARA TENTAR DE NOVO --\n");
...
//==================================================
	...
	void textoinicial(){
		printf("\nSerruya, um estudante universitario qualquer, estava lutando para se manter acordado durante a aula de segunda-feira de");
		printf(" manha. Na noite anterior, ele tinha passado horas e horas apostando no tigrinho, perdendo a nocao do tempo enquanto a adrenalina corria solta.\n");
		getch();
		system("cls");
		printf("\nOs olhos de Serruya piscavam lentamente enquanto ele tentava acompanhar as palavras do professor.");
		printf(" Mas, contra todas as probabilidades, ele sucumbe ao cansaco e afunda em um sono profundo.\n");
		getch();
		system("cls");
		printf("\nQuando ele finalmente desperta, nao se ve rodeado pela luz suave da manha, mas sim pelo obscuro breu que o cerca. Confuso e atordoado, ");
		printf("ele percebe que esta sozinho na sala de aula.\n");
		getch();
		system("cls");
		printf("\nSerruya se levanta. Sua mente turva tenta entender o que havia ocorrido. Ele tenta acender as luzes, mas nada acontece.");
		printf(" Um calafrio percorre sua espinha quando ele percebe que esta preso na escuridao da Argo.\n");
		getch();
		system("cls");
		printf("\nEnquanto avanca pelos corredores desertos, uma sensacao de terror cresce dentro de Serruya, ate que ele finalmente percebe a verdade horripilante: ");
		printf("Os professores nao sao o que parecem. Eles sao monstros        disfarcados, criaturas que assumiram a forma dos educadores da faculdade para atrair e capturar estudantes desavisados.\n");
		getch();
		system("cls");
		printf("\nCom o coracao batendo freneticamente, Serruya percebe que sua unica chance de escapar e enfrentar as");
		printf(" criaturas e encontrar uma saida da faculdade, antes que seja tarde demais...\n");
		getch();
		system("cls");
		printf("\nSeu objetivo e derrotar os monstros e escapar da Argo.\n");
		getch();
	}
